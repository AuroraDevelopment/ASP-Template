...
namespace KH_Template
{
	...
	public class Event
	{
		#region Construction
		/// <summary>
		/// Initializes a new (no-args) instance of the Event class.
		/// </summary>
		public Event()
		{
		}
		...
		/// </summary>
		public Event(Int32 ID, String Name, String Title, String Detail, String URL, String Type, DateTime Created_On, String Created_By, DateTime Last_Modified_On, String Last_Modified_By, DateTime StartDate, DateTime EndDate, Int32 AllDay)
		{
			this.ID = ID;
			this.Name = Name;
			this.Title = Title;
		...
		/// </summary>
		public virtual Int32 AllDay { get; set; }
		#endregion
		...
		public override Boolean Equals(Object ObjectToCompare)
		{
			...
			return Event.Equals(this, otherObject);
		}
